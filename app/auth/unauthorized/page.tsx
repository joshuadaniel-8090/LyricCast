        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Link href="/auth/signup">
              <Button variant="outline" className="w-full py-2 px-4 border-2 hover:bg-gray-50 transition-all duration-200">
                Create New Account
              </Button>
            </Link>
            
            <Link href="/">
              <Button variant="ghost" className="w-full py-2 px-4 text-gray-600 hover:text-gray-800 hover:bg-gray-100 transition-all duration-200">
